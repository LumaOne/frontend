								...
								<tr key={dept.id}>
									...
									<td>
										<Badge
											size="sm"
											style={{
												backgroundColor: dept.policies.autoBlock
													? "rgba(34, 197, 94, 0.1)"
													: "rgba(239, 68, 68, 0.1)",
									...
									<td>
										<Badge
											size="sm"
											style={{
												backgroundColor: dept.policies.quarantine
													? "rgba(34, 197, 94, 0.1)"
													: "rgba(239, 68, 68, 0.1)",
									...
									<td>
										<Badge
											size="sm"
											style={{
												backgroundColor: dept.policies.allowExternal
													? "rgba(245, 158, 11, 0.1)"
													: "rgba(34, 197, 94, 0.1)",
												color: dept.policies.allowExternal
													? "#f59e0b"
													: "#22c55e",
											}}
										>
									...
									<td>
										<Badge
											size="sm"
											style={{
												backgroundColor: dept.policies.mfaRequired
													? "rgba(34, 197, 94, 0.1)"
													: "rgba(239, 68, 68, 0.1)",
												color: dept.policies.mfaRequired
													? "#22c55e"
													: "#ef4444",
											}}
										>
