...
import ThreatChart from "../../components/ui/charts/ThreatChart";
import UsageChart from "../../components/ui/charts/UsageChart";
import DepartmentChart from "../../components/ui/charts/DepartmentChart";
		...
		<div>
			...
			<SimpleGrid cols={4} spacing="lg" mb="xl">
				...
				<MetricCard
					...
					value={
						stats?.avgProcessingTime ? `${stats.avgProcessingTime}ms` : "0ms"
					}
					change={0.1}
					icon={FaCheckCircle}
					color="#f59e0b"
			...
			{/* Charts Section */}
			<SimpleGrid cols={isMobile ? 1 : isTablet ? 1 : 2} spacing="lg" mb="xl">
				...
				>
					...
					<ThreatChart height={isMobile ? 250 : 300} />
				</Card>
				...
				>
					...
					<UsageChart height={isMobile ? 250 : 300} />
				</Card>
			</SimpleGrid>
			...
			>
				...
				<DepartmentChart height={isMobile ? 250 : 300} />
			</Card>
				...
				<Grid.Col span={8}>
					...
					>
						...
						{loading ? (
							...
							>
								<Text size="sm">{`// No threats detected yet`}</Text>
								<Text size="xs" mt="xs">
