...
import { Card, Text, Group, Badge, Select, Button, SimpleGrid, Progress } from '@mantine/core';
import { FaChartLine, FaDownload, FaCalendarAlt, FaShieldAlt, FaExclamationTriangle, FaCheckCircle, FaClock } from 'react-icons/fa';
          ...
          <Group spacing="xs">
            {['threats', 'performance', 'compliance'].map((type) => (
              <Button
                ...
                style={{ 
                  backgroundColor: reportType === type ? 'rgba(34, 197, 94, 0.2)' : 'transparent',
            ...
            <SimpleGrid cols={3} spacing="lg">
              <div>
                ...
                <Progress 
                  ...
                  size="sm"
                  color="#22c55e"
                  style={{ backgroundColor: 'rgba(34, 197, 94, 0.1)', marginTop: '8px' }}
                />
              </div>
              ...
              <div>
                ...
                <Text 
                  size="xs" 
                  color="#94a3b8"
                  style={{ fontFamily: '"JetBrains Mono", monospace', marginTop: '8px' }}
                >
                  0.006% rate
                </Text>
              </div>
